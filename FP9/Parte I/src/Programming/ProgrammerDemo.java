...
public class ProgrammerDemo {
    ...
    public static void main(String[] args) {
        ...
        ProjectManager person3 = new ProjectManager("Manuel", "01-08-1998", "Felgueiras", 657465, 652123, 1000, 2, new String[]{"Java Develop", "Scrum"}, new Date(2019, Calendar.APRIL,6));
